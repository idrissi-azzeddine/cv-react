...
<MDBRow tag="form"  className='g-3 aq'>
    ...
    <MDBCol md="4">
        <MDBInput value={formValue.lname} name='lname' onChange={handleChange} id='2' required
            label='Last name' />
    </MDBCol>
    <MDBCol md="4">
        <MDBInput value={formValue.age} name='age' onChange={handleChange} id='3' required
            label='Age' />
    </MDBCol>
    ...
    <MDBCol md="6">
        <MDBInput value={formValue.email} name='email' onChange={handleChange} id='4' required
            label='Email' />
    </MDBCol>
    <MDBCol md="6">
        <MDBInput value={formValue.zip} name='adress' onChange={handleChange} id='5' required
            label='Adresse' />
    </MDBCol>
    ...
    <MDBCol md="4">
        <MDBInput value={formValue.tele} name='tele' onChange={handleChange} id='6' required
            label='Number' />
    </MDBCol>
    <MDBCol md="4">
        <MDBInput value={formValue.fix} name='fix' onChange={handleChange} id='7' required
            label='Fix' />
    </MDBCol>
    <MDBCol md="4">
    ...
    <MDBCol md="12">
        <MDBInput value={formValue.site} name='site' onChange={handleChange} id='9' required
    ...
    <MDBCol size='12'>
        <MDBTextArea label='Message' id='10' name='message' value={formValue.message} onChange={handleChange} rows={4} />
    </MDBCol>
    ...
    <MDBCol size='2'>
        <MDBInput value={formValue.année} type='number' name='année' onChange={handleChange} id='11'
            required label='Année' />
    </MDBCol>
    <MDBCol size='9'>
        <MDBInput value={formValue.carrière} name='carrière' onChange={handleChange} id='12' required
            label='carrière' />
    </MDBCol>
    ...
    <MDBInput value={formValue.année2} type='number' name='année2' className='zwei' onChange={handleChange} id='13' 
            required label='Année' />
    </MDBCol>
    ...
    <MDBInput value={formValue.année3} type='number' name='année3' className='drei' onChange={handleChange} id='15'
            required label='Année' />
    </MDBCol>
    ...
    <MDBCol size='2'>
        <MDBInput value={formValue.annéep} type='number' name='annéep' onChange={handleChange} id='17'
            required label='Année' />
    </MDBCol>
    <MDBCol size='9'>
        <MDBInput value={formValue.parcour} name='parcour' onChange={handleChange} id='18' required
    ...
    <MDBCol size='2' className='fier'>
        <MDBInput value={formValue.annéep2} type='number' className='fier' name='annéep2' onChange={handleChange} id='19'
            required label='Année' />
    </MDBCol>
    ...
    <MDBCol size='2' className='funf'>
        <MDBInput value={formValue.annéep3} type='number' className='funf' name='annéep3' onChange={handleChange} id='21'
            required label='Année' />
    </MDBCol>
    ...
    <MDBCol size="12">
            <MDBBtn type='button' className='as' onFocus={handleClick} id='existing-button'> Créer mon cv </MDBBtn> 
    </MDBCol>
